...
const AdminProduct = () => {
    ...
    }, [isSuccessDelectedMany, isErrorDeletedMany, dataDeletedMany?.status])
    ...
    return (
        <div>
            ...
            <div style={{ marginTop: '20px' }}>
                <TableComponent handleDelteMany={handleDelteManyProducts} columns={columns} isLoading={isLoadingProduct} data={dataTable} onRow={(record, rowIndex) => {
                    return {
                        onClick: event => {
